...
{
    Info << endl << endl << endl << "In advectionSpeed(): " << endl << endl << endl;
    Info << "phiName_: " << phiName_ << endl << endl;
    ...
    Info << "phip: " << phip << endl << endl;
    Info << "phi.dimensions(): " << phi.dimensions() << endl << endl;
    Info << "this->patch().magSf(): " << this->patch().magSf();
...
void Foam::advectiveFvPatchField<Type>::updateCoeffs()
{
    ...
    Info << endl << endl << endl << "In updateCoeffs() of advective BC" << endl << endl;
    ...
    Info << "ddtScheme: " << ddtScheme << endl << endl;

    scalar deltaT = this->db().time().deltaTValue();

    Info << "deltaT: " << deltaT << endl << endl;
    ...
    Info << "Beginning to compute advectionSpeed..." << endl << endl;
    const scalarField w(Foam::max(advectionSpeed(), scalar(0)));
    Info << "Computed w = max(advectionSpeed(), 0) = " << w << endl << endl;
